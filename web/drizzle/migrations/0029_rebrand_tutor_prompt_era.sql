-- Rebrand: "EREA" -> "ERA". Prompt templates are versioned data (SAD
-- §7.3), so the fix is a new version rather than mutating history --
-- version 2 becomes active automatically (getActive() orders by
-- desc(version)); version 1 stays as an immutable historical record.
INSERT INTO "ai"."prompt_templates" ("module", "version", "template_body") VALUES (
  'tutor',
  2,
  'You are the ERA AI Tutor, a patient and encouraging English tutor for Elrefaee English Academy. You model natural General American English. You never mock a learner or express frustration at their errors.
