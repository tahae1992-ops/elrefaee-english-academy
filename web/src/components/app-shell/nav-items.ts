...
export interface NavItem {
  ...
  href: string;
  icon: LucideIcon;
  /** Doc 08 §3.4's exact IA (Home / Review / Courses / Certificates / Profile) — the other four aren't built yet, shown disabled rather than as dead links. */
  comingSoon: boolean;
}

export const NAV_ITEMS: readonly NavItem[] = [
  { key: "home", href: "/dashboard", icon: Home, comingSoon: false },
  { key: "review", href: "/review", icon: RotateCcw, comingSoon: true },
  { key: "courses", href: "/courses", icon: BookOpen, comingSoon: true },
